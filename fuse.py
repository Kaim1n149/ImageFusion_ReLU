...
from models.DenseNet_add import DenseNet, DenseNet_half
...
if __name__ == '__main__':
    ...
    #LLVIP
    #parser.add_argument("--ir", default='../datasets/LLVIP/infrared/test', help="ir path")
    #parser.add_argument("--vi", default='../datasets/LLVIP/visible/test', help="vi path")
    #NCHU_0007
    #parser.add_argument("--ir", default='../datasets/NCHU/dongshi_0007/ir', help="ir path")
    #parser.add_argument("--vi", default='../datasets/NCHU/dongshi_0007/vi', help="vi path")
    #For_PPT
    parser.add_argument("--ir", default='../datasets/LLVIP/for_ppt/ir', help="ir path")
    parser.add_argument("--vi", default='../datasets/LLVIP/for_ppt/vi', help="vi path")
    #TNO Nato
    #parser.add_argument("--ir", default='../datasets/TNO/TNO_Duine_Nato_Tree/Nato_sequence/thermal', help="ir path")
    #parser.add_argument("--vi", default='../datasets/TNO/TNO_Duine_Nato_Tree/Nato_sequence/visual', help="vi path")
    
    args = parser.parse_args()
    
    #f(args.ir, args.vi, f'runs/test/{model}/fuse')
    #f(args.ir, args.vi, f'runs/nchu/{model}/fuse')
    f(args.ir, args.vi, f'runs/for_ppt/{model}/fuse')
    #f(args.ir, args.vi, f'runs/tno/nato/{model}/fuse')
